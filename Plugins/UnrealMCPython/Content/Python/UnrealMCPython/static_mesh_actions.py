...
ACTION_METADATA = {'add_simple_collision': {'asset_path_params': ['asset_path'],
                          'description': 'Adds a simple collision primitive to a StaticMesh. '
                                         'shape: BOX, SPHERE, CAPSULE, NDOP10_X/Y/Z, NDOP18, '
                                         'NDOP26.',
                          'effect': 'write',
                          'idempotent': False,
                          'required_plugins': [],
                          ...
                          'supports_undo': True,
                          'title': 'Add Simple Collision',
                          'ue_versions': ['5.6', '5.7', '5.8']},
 'get_collision_info': {'asset_path_params': ['asset_path'],
                        'description': 'Returns collision complexity and simple/convex collision '
                                       'counts of a StaticMesh.',
                        'effect': 'read',
                        'idempotent': True,
                        'required_plugins': [],
                        ...
                        'supports_undo': False,
                        'title': 'Get Collision Info',
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'get_lod_screen_sizes': {'asset_path_params': ['asset_path'],
                          'description': 'Returns the screen-size threshold of each LOD on a '
                                         'StaticMesh.',
                          'effect': 'read',
                          'idempotent': True,
                          'required_plugins': [],
                          ...
                          'ue_versions': ['5.6', '5.7', '5.8']},
 'get_static_mesh_info': {'asset_path_params': ['asset_path'],
                          'description': 'Returns LOD/section/triangle/vertex/material counts and '
                                         'Nanite state of a StaticMesh.',
                          'effect': 'read',
                          'idempotent': True,
                          'required_plugins': [],
                          'requires_confirmation': False,
                          ...
                          'supports_preview': False,
                          'supports_undo': False,
                          'title': 'Get Static Mesh Info',
                          'ue_versions': ['5.6', '5.7', '5.8']},
 'list_static_mesh_materials': {'asset_path_params': ['asset_path'],
                                'description': 'Lists the material slots of a StaticMesh (slot '
                                               'index + material path).',
                                'effect': 'read',
                                'idempotent': True,
                                'required_plugins': [],
                                ...
                                'supports_preview': False,
                                'supports_undo': False,
                                'title': 'List Static Mesh Materials',
                                'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_collisions': {'asset_path_params': ['asset_path'],
                       'description': 'Removes all simple/convex collision from a StaticMesh.',
                       'effect': 'destructive',
                       'idempotent': False,
                       'required_plugins': [],
                       'requires_confirmation': True,
                       ...
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_lods': {'asset_path_params': ['asset_path'],
                 'description': 'Removes all LODs except LOD 0 from a StaticMesh.',
                 'effect': 'destructive',
                 'idempotent': False,
                 'required_plugins': [],
                 'requires_confirmation': True,
                 ...
                 'title': 'Remove Lods',
                 'ue_versions': ['5.6', '5.7', '5.8']},
 'set_convex_collision': {'asset_path_params': ['asset_path'],
                          'description': 'Replaces simple collision with auto-generated convex '
                          ...
                          'supports_preview': True,
                          'supports_undo': True,
                          'title': 'Set Convex Collision',
                          'ue_versions': ['5.6', '5.7', '5.8']},
 'set_lod_for_collision': {'asset_path_params': ['asset_path'],
                           'description': "Sets which LOD's geometry is used for complex collision "
                                          'on a StaticMesh.',
                           'effect': 'write',
                           'idempotent': False,
                           'required_plugins': [],
                           ...
                           'supports_preview': True,
                           'supports_undo': True,
                           'title': 'Set Lod For Collision',
                           'ue_versions': ['5.6', '5.7', '5.8']},
 'set_lod_from_static_mesh': {'asset_path_params': ['asset_path', 'source_path'],
                              'description': 'Adds/sets a LOD on a StaticMesh using geometry from '
                                             "another StaticMesh's LOD.",
                              'effect': 'write',
                              'idempotent': False,
                              'required_plugins': [],
                              'requires_confirmation': True,
                              ...
                              'ue_versions': ['5.6', '5.7', '5.8']},
 'set_lods': {'asset_path_params': ['asset_path'],
              'description': 'Generates LODs from reduction settings: '
                             'lod_settings=[{percent_triangles, screen_size}, ...] (LOD0 first).',
              'effect': 'write',
              'idempotent': False,
              'required_plugins': [],
              'requires_confirmation': True,
              ...
              'title': 'Set Lods',
              'ue_versions': ['5.6', '5.7', '5.8']},
 'set_static_mesh_material': {'asset_path_params': ['asset_path', 'material_path'],
                              'description': 'Assigns a material to a StaticMesh material slot.',
                              'effect': 'write',
                              'idempotent': False,
                              'required_plugins': [],
                              'requires_confirmation': True,
                              ...
                              'supports_preview': True,
                              'supports_undo': True,
                              'title': 'Set Static Mesh Material',
                              'ue_versions': ['5.6', '5.7', '5.8']}}
