...
ACTION_METADATA = {'create_data_table': {'asset_path_params': ['asset_path', 'row_struct_path'],
                       'description': 'Creates a DataTable asset with the given row struct (e.g. '
                                      "'/Script/MyModule.MyRow' or a UserDefinedStruct path).",
                       'effect': 'write',
                       'idempotent': False,
                       'required_plugins': [],
 ...
 'does_row_exist': {'asset_path_params': ['asset_path'],
                    'description': 'Returns whether a row exists in a DataTable.',
                    'effect': 'read',
                    'idempotent': True,
                    'required_plugins': [],
                    ...
                    'supports_undo': False,
                    'title': 'Does Row Exist',
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'export_to_csv': {'asset_path_params': ['asset_path'],
                   'description': 'Returns all rows of a DataTable as a CSV string.',
                   'effect': 'write',
                   'idempotent': False,
                   'required_plugins': [],
                   'requires_confirmation': True,
                   ...
                   'title': 'Export To Csv',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'get_column_names': {'asset_path_params': ['asset_path'],
                      'description': "Lists the column (property) names of a DataTable's row "
                                     'struct.',
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': [],
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'get_row_names': {'asset_path_params': ['asset_path'],
                   'description': 'Lists the row names of a DataTable.',
                   'effect': 'read',
                   'idempotent': True,
                   'required_plugins': [],
                   'requires_confirmation': False,
                   ...
                   'title': 'Get Row Names',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'get_rows_as_json': {'asset_path_params': ['asset_path'],
                      'description': 'Returns all rows of a DataTable as a JSON string (under the '
                                     "'rows' field).",
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': [],
                      ...
                      'supports_preview': False,
                      'supports_undo': False,
                      'title': 'Get Rows As Json',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_row': {'asset_path_params': ['asset_path'],
                'description': 'Removes a row from a DataTable by name.',
                'effect': 'destructive',
                'idempotent': False,
                'required_plugins': [],
                'requires_confirmation': True,
                ...
                'title': 'Remove Row',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'set_rows_from_json': {'asset_path_params': ['asset_path'],
                        'description': "Replaces a DataTable's rows from a JSON string (array of "
                                       "row objects with a 'Name' key).",
                        'effect': 'destructive',
                        'idempotent': False,
                        'required_plugins': [],
                        'requires_confirmation': True,
