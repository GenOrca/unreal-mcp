...
ACTION_METADATA = {'add_effect_modifier': {'asset_path_params': ['asset_path', 'attribute_set_path'],
                         'description': 'Appends an attribute modifier (e.g. Health add_base +25) '
                                        'to a GameplayEffect. attribute_set_path is the '
                                        'AttributeSet class path (requires the GameplayAbilities '
                                        'plugin).',
                         'effect': 'write',
                         'idempotent': False,
                         'required_plugins': ['GameplayAbilities'],
                         'requires_confirmation': True,
                         'result_kind': 'json',
                         'risk': 'medium',
                         'supports_preview': True,
                         'supports_undo': True,
                         'title': 'Add Effect Modifier',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'add_gameplay_tag': {'description': 'Registers a gameplay tag in Config/DefaultGameplayTags.ini — '
                                     'takes effect after an editor restart (requires the '
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'clear_effect_modifiers': {'asset_path_params': ['asset_path'],
                            'description': 'Removes all modifiers from a GameplayEffect blueprint '
                                           '(requires the GameplayAbilities plugin).',
                            'effect': 'destructive',
                            'idempotent': False,
                            'required_plugins': ['GameplayAbilities'],
                            'requires_confirmation': True,
                            ...
                            'supports_preview': True,
                            'supports_undo': False,
                            'title': 'Clear Effect Modifiers',
                            'ue_versions': ['5.6', '5.7', '5.8']},
 'create_ability_blueprint': {'asset_path_params': ['asset_path', 'parent_class_path'],
                              'description': 'Creates a GameplayAbility blueprint; '
                                             'parent_class_path may point at a custom GA subclass '
                                             '(requires the GameplayAbilities plugin).',
                              'effect': 'write',
                              'idempotent': False,
                              'required_plugins': ['GameplayAbilities'],
                              ...
                              'supports_preview': True,
                              'supports_undo': True,
                              'title': 'Create Ability Blueprint',
                              'ue_versions': ['5.6', '5.7', '5.8']},
 'create_effect_blueprint': {'asset_path_params': ['asset_path'],
                             'description': 'Creates a GameplayEffect blueprint with a duration '
                                            'policy: instant, has_duration (+seconds), or infinite '
                                            '(requires the GameplayAbilities plugin).',
                             'effect': 'write',
                             'idempotent': False,
                             'required_plugins': ['GameplayAbilities'],
                             ...
                             'supports_preview': True,
                             'supports_undo': True,
                             'title': 'Create Effect Blueprint',
                             'ue_versions': ['5.6', '5.7', '5.8']},
 'get_ability_info': {'asset_path_params': ['asset_path'],
                      'description': 'Returns parent class, ability tags, and cost/cooldown effect '
                                     'classes of a GameplayAbility blueprint (requires the '
                                     'GameplayAbilities plugin).',
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': ['GameplayAbilities'],
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'get_effect_info': {'asset_path_params': ['asset_path'],
                     'description': 'Returns duration policy/seconds and decoded modifiers of a '
                                    'GameplayEffect blueprint (requires the GameplayAbilities '
                                    'plugin).',
                     'effect': 'read',
                     'idempotent': True,
                     'required_plugins': ['GameplayAbilities'],
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'list_gameplay_tags': {'description': 'Lists gameplay tags registered in '
                                       'Config/DefaultGameplayTags.ini, optionally filtered by '
                                       'prefix (requires the GameplayAbilities plugin).',
                        'effect': 'read',
                        'idempotent': True,
                        'required_plugins': ['GameplayAbilities'],
                        'requires_confirmation': False,
                        ...
                        'supports_preview': False,
                        'supports_undo': False,
                        'title': 'List Gameplay Tags',
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'set_ability_costs': {'asset_path_params': ['asset_path',
                                             'cost_effect_path',
                                             'cooldown_effect_path'],
                       'description': 'Wires cost and/or cooldown GameplayEffect blueprints onto a '
                                      'GameplayAbility (requires the GameplayAbilities plugin).',
                       'effect': 'write',
                       'idempotent': False,
                       'required_plugins': ['GameplayAbilities'],
                       'requires_confirmation': True,
                       ...
                       'supports_preview': True,
                       'supports_undo': True,
                       'title': 'Set Ability Costs',
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'set_ability_tags': {'asset_path_params': ['asset_path'],
                      'description': 'Sets the AbilityTags container on a GameplayAbility; '
                                     'unregistered tags are reported, not silently dropped '
                                     '(requires the GameplayAbilities plugin).',
                      'effect': 'write',
                      'idempotent': False,
                      'required_plugins': ['GameplayAbilities'],
                      ...
                      'supports_preview': True,
                      'supports_undo': True,
                      'title': 'Set Ability Tags',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'set_effect_duration': {'asset_path_params': ['asset_path'],
                         'description': "Changes a GameplayEffect's duration policy (instant / "
                                        'has_duration+seconds / infinite) (requires the '
                                        'GameplayAbilities plugin).',
                         'effect': 'write',
                         'idempotent': False,
                         'required_plugins': ['GameplayAbilities'],
