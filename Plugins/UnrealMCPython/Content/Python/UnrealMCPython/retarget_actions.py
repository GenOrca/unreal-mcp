...
ACTION_METADATA = {'add_retarget_chain': {'asset_path_params': ['ik_rig_path'],
                        'description': "Adds a retarget chain (e.g. 'Spine': spine_01..spine_03) "
                                       'to an IK Rig (requires the IKRig plugin).',
                        'effect': 'write',
                        'idempotent': False,
                        'required_plugins': ['IKRig'],
 ...
 'auto_map_chains': {'asset_path_params': ['retargeter_path'],
                     'description': 'Re-runs chain mapping on an IK Retargeter. mode: FUZZY, '
                                    'EXACT, or CLEAR (requires the IKRig plugin).',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': ['IKRig'],
                     'requires_confirmation': True,
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'batch_retarget': {'asset_path_params': ['retargeter_path',
                                          'anim_paths',
                                          'source_mesh_path',
                                          'target_mesh_path'],
                    'description': 'Duplicates and retargets animations through an IK Retargeter; '
                                   'returns the new asset paths (requires the IKRig plugin).',
                    'effect': 'write',
                    'idempotent': False,
                    'required_plugins': ['IKRig'],
                    'requires_confirmation': True,
                    ...
                    'supports_preview': True,
                    'supports_undo': True,
                    'title': 'Batch Retarget',
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'create_ik_rig': {'asset_path_params': ['asset_path', 'skeletal_mesh_path'],
                   'description': 'Creates an IK Rig for a skeletal mesh, optionally setting the '
                                  'retarget root bone (requires the IKRig plugin).',
                   'effect': 'write',
                   'idempotent': False,
                   'required_plugins': ['IKRig'],
                   'requires_confirmation': True,
                   ...
                   'title': 'Create Ik Rig',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'create_retargeter': {'asset_path_params': ['asset_path',
                                             'source_ik_rig_path',
                                             'target_ik_rig_path'],
                       'description': 'Creates an IK Retargeter wired to source/target IK Rigs, '
                                      'with optional fuzzy chain auto-mapping (requires the IKRig '
                                      'plugin).',
                       'effect': 'write',
                       'idempotent': False,
                       'required_plugins': ['IKRig'],
                       ...
                       'supports_preview': True,
                       'supports_undo': True,
                       'title': 'Create Retargeter',
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'get_ik_rig_info': {'asset_path_params': ['ik_rig_path'],
                     'description': 'Returns the skeletal mesh, retarget root, and chains of an IK '
                                    'Rig (requires the IKRig plugin).',
                     'effect': 'read',
                     'idempotent': True,
                     'required_plugins': ['IKRig'],
