...
ACTION_METADATA = {'add_widget': {'asset_path_params': ['asset_path'],
 ...
 'bind_widget_event': {'asset_path_params': ['asset_path'],
                       'description': "Creates a bound event node in the widget BP's event graph "
                                      'for a widget delegate (e.g. Button OnClicked).',
                       'effect': 'write',
                       'idempotent': False,
                       'required_plugins': [],
                       'requires_confirmation': True,
                       ...
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'compile_widget_blueprint': {'asset_path_params': ['asset_path'],
                              ...
                              'ue_versions': ['5.6', '5.7', '5.8']},
 'create_widget_blueprint': {'asset_path_params': ['path'],
                             'description': 'Create widget blueprint.',
                             'effect': 'write',
                             'idempotent': False,
                             'required_plugins': [],
                             'requires_confirmation': True,
                             ...
                             'ue_versions': ['5.6', '5.7', '5.8']},
 'get_widget_blueprint_info': {'asset_path_params': ['asset_path'],
                               'description': 'Get widget blueprint info.',
                               'effect': 'read',
                               'idempotent': True,
                               'required_plugins': [],
                               ...
                               'supports_preview': False,
                               'supports_undo': False,
                               'title': 'Get Widget Blueprint Info',
                               'ue_versions': ['5.6', '5.7', '5.8']},
 'get_widget_property': {'asset_path_params': ['asset_path'],
                         'description': 'Gets the value of a C++ UPROPERTY on a named widget.',
                         'effect': 'read',
                         'idempotent': True,
                         'required_plugins': [],
                         'requires_confirmation': False,
                         ...
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'list_widget_events': {'asset_path_params': ['asset_path'],
                        'description': 'Lists the bindable multicast-delegate events on a widget '
                                       '(e.g. OnClicked, OnHovered).',
                        'effect': 'read',
                        'idempotent': True,
                        'required_plugins': [],
                        'requires_confirmation': False,
                        ...
                        'supports_preview': False,
                        'supports_undo': False,
                        'title': 'List Widget Events',
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_widget': {'asset_path_params': ['asset_path'],
                   ...
                   'title': 'Remove Widget',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'reparent_widget': {'asset_path_params': ['asset_path'],
                     'description': 'Moves a widget under a different panel parent '
                                    '(cycle-guarded).',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     ...
                     'supports_preview': True,
                     'supports_undo': True,
                     'title': 'Reparent Widget',
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'replace_widget': {'asset_path_params': ['asset_path'],
                    'description': 'Replaces a widget with a new widget of new_type at the same '
                                   'slot (old subtree discarded).',
                    'effect': 'write',
                    'idempotent': False,
                    'required_plugins': [],
                    'requires_confirmation': True,
                    ...
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'set_slot_layout': {'asset_path_params': ['asset_path'],
                     'description': 'Sets CanvasPanelSlot layout (anchors + offset + size) on a '
                                    'widget.',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     ...
                     'supports_preview': True,
                     'supports_undo': True,
                     'title': 'Set Slot Layout',
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'set_text_style': {'asset_path_params': ['asset_path'],
                    'description': 'Sets font size, text color, and outline size on a TextBlock '
                                   'widget.',
                    'effect': 'write',
                    'idempotent': False,
                    'required_plugins': [],
                    ...
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'set_widget_properties': {'asset_path_params': ['asset_path'],
                           'description': 'Set widget properties.',
                           'effect': 'write',
                           'idempotent': False,
                           'required_plugins': [],
                           'requires_confirmation': True,
                           ...
                           'ue_versions': ['5.6', '5.7', '5.8']},
 'set_widget_property': {'asset_path_params': ['asset_path'],
                         'description': 'Sets a C++ UPROPERTY on a named widget from a string '
                                        'value.',
                         'effect': 'write',
                         'idempotent': False,
                         'required_plugins': [],
                         ...
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'wrap_widget': {'asset_path_params': ['asset_path'],
                 'description': "Wraps a widget in a new panel (wrapper_type, e.g. 'VerticalBox') "
