...
ACTION_METADATA = {'close_asset_editor': {'asset_path_params': ['asset_path'],
                        'description': 'Closes any open editor for the given asset.',
                        'effect': 'write',
                        'idempotent': False,
                        'required_plugins': [],
                        ...
                        'supports_undo': False,
                        'title': 'Close Asset Editor',
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'create_proxy_actor': {'description': 'Bakes static mesh actors into ONE simplified proxy mesh '
                                       '(Proxy Geometry tool) and spawns it.',
                        'effect': 'write',
                        'idempotent': False,
                        'required_plugins': [],
                        'requires_confirmation': True,
                        ...
                        'supports_undo': True,
                        'title': 'Create Proxy Actor',
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'get_open_assets': {'description': 'Lists assets that currently have an editor open.',
                     'effect': 'read',
                     'idempotent': True,
                     'required_plugins': [],
                     ...
                     'supports_preview': False,
                     'supports_undo': False,
                     'title': 'Get Open Assets',
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'get_selected_assets': {'description': 'Gets the set of currently selected assets.',
                         'effect': 'read',
                         'idempotent': True,
                         'required_plugins': [],
                         'requires_confirmation': False,
                         ...
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'join_actors': {'description': 'Joins static mesh actors into one actor with multiple components '
                                '(no new mesh asset is baked).',
                 'effect': 'destructive',
                 'idempotent': False,
                 'required_plugins': [],
                 'requires_confirmation': True,
                 ...
                 'title': 'Join Actors',
                 'ue_versions': ['5.6', '5.7', '5.8']},
 'merge_actors': {'description': 'Merges static mesh actors into ONE new static mesh asset + actor '
                                 '(geometry is baked together).',
                  'effect': 'destructive',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Merge Actors',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'open_editor_for_asset': {'asset_path_params': ['asset_path'],
                           'description': 'Opens the asset-specific editor (Blueprint, Material, '
                                          'etc.) for an asset.',
                           'effect': 'write',
                           'idempotent': False,
                           'required_plugins': [],
                           ...
                           'supports_preview': False,
                           'supports_undo': False,
                           'title': 'Open Editor For Asset',
                           'ue_versions': ['5.6', '5.7', '5.8']},
 'replace_mesh_on_selected': {'asset_path_params': ['mesh_to_be_replaced_path', 'new_mesh_path'],
                              'description': 'Replaces static meshes on components of selected '
                                             "actors using Unreal's batch API if available.",
                              'effect': 'write',
                              'idempotent': False,
                              'required_plugins': [],
                              'requires_confirmation': True,
                              ...
                              'supports_preview': True,
                              'supports_undo': True,
                              'title': 'Replace Mesh On Selected',
                              'ue_versions': ['5.6', '5.7', '5.8']},
 'replace_mesh_on_specified': {'asset_path_params': ['mesh_to_be_replaced_path', 'new_mesh_path'],
                               'description': 'Replaces static meshes on components of specified '
                                              "actors using Unreal's batch API if available.",
                               'effect': 'write',
                               'idempotent': False,
                               'required_plugins': [],
                               ...
                               'supports_preview': True,
                               'supports_undo': True,
                               'title': 'Replace Mesh On Specified',
                               'ue_versions': ['5.6', '5.7', '5.8']},
 'replace_mtl_on_selected': {'asset_path_params': ['material_to_be_replaced_path',
                                                   'new_material_path'],
                             'description': 'Replace mtl on selected.',
                             'effect': 'write',
                             'idempotent': False,
                             'required_plugins': [],
                             'requires_confirmation': True,
                             ...
                             'supports_preview': True,
                             'supports_undo': True,
                             'title': 'Replace Mtl On Selected',
                             'ue_versions': ['5.6', '5.7', '5.8']},
 'replace_mtl_on_specified': {'asset_path_params': ['material_to_be_replaced_path',
                                                    'new_material_path'],
                              'description': 'Replace mtl on specified.',
                              'effect': 'write',
                              'idempotent': False,
                              'required_plugins': [],
                              'requires_confirmation': True,
                              ...
                              'supports_preview': True,
                              'supports_undo': True,
                              'title': 'Replace Mtl On Specified',
                              'ue_versions': ['5.6', '5.7', '5.8']},
 'replace_selected_with_bp': {'asset_path_params': ['blueprint_asset_path'],
                              'description': 'Replaces the currently selected actors with new '
                                             'actors spawned from a specified Blueprint asset path '
                                             "using Unreal's official API.",
                              'effect': 'destructive',
                              'idempotent': False,
                              'required_plugins': [],
                              'requires_confirmation': True,
                              ...
                              'supports_preview': True,
                              'supports_undo': False,
                              'title': 'Replace Selected With Bp',
                              'ue_versions': ['5.6', '5.7', '5.8']}}
