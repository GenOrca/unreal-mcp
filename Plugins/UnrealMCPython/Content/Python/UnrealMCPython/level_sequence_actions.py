...
ACTION_METADATA = {'add_anim_track': {'asset_path_params': ['asset_path', 'anim_path'],
                    'description': 'Adds a skeletal-animation track playing anim_path on a binding '
                                   '(defaults to the playback range).',
                    'effect': 'write',
                    'idempotent': False,
                    'required_plugins': [],
                    ...
                    'supports_undo': True,
                    'title': 'Add Anim Track',
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'add_camera': {'asset_path_params': ['asset_path'],
                'description': 'Adds a CineCamera to a Level Sequence with a Camera Cut track '
                               'bound to it (official create_camera path).',
                'effect': 'write',
                'idempotent': False,
                'required_plugins': [],
                'requires_confirmation': True,
                ...
                'title': 'Add Camera',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'add_possessable': {'asset_path_params': ['asset_path'],
                     'description': 'Adds a possessable binding for an existing level actor (by '
                                    'World Outliner label). Returns the binding name.',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     'requires_confirmation': True,
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'add_spawnable_from_class': {'asset_path_params': ['asset_path', 'class_path'],
                              'description': 'Adds a spawnable binding from a class path (e.g. '
                                             "'/Script/CinematicCamera.CineCameraActor'). Returns "
                                             'the binding name.',
                              'effect': 'write',
                              'idempotent': False,
                              'required_plugins': [],
                              ...
                              'ue_versions': ['5.6', '5.7', '5.8']},
 'add_transform_keyframe': {'asset_path_params': ['asset_path'],
                            'description': "Adds a keyframe at time_seconds on a binding's "
                                           'transform track. Provide any of',
                            'effect': 'write',
                            'idempotent': False,
                            'required_plugins': [],
                            'requires_confirmation': True,
                            ...
                            'supports_preview': True,
                            'supports_undo': True,
                            'title': 'Add Transform Keyframe',
                            'ue_versions': ['5.6', '5.7', '5.8']},
 'add_transform_track': {'asset_path_params': ['asset_path'],
                         'description': 'Adds a 3D transform track (with one section) to a '
                                        'binding.',
                         'effect': 'write',
                         'idempotent': False,
                         'required_plugins': [],
                         ...
                         'supports_preview': True,
                         'supports_undo': True,
                         'title': 'Add Transform Track',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'close_sequencer': {'description': 'Closes the Sequencer editor if one is open.',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     'requires_confirmation': True,
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'convert_binding': {'asset_path_params': ['asset_path'],
                     'description': 'Converts a binding between possessable and spawnable. '
                                    "to='spawnable' or 'possessable'.",
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     'requires_confirmation': True,
                     ...
                     'supports_preview': True,
                     'supports_undo': True,
                     'title': 'Convert Binding',
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'create_level_sequence': {'asset_path_params': ['asset_path'],
                           'description': 'Creates a Level Sequence asset with the given frame '
                                          'rate and playback duration.',
                           'effect': 'write',
                           'idempotent': False,
                           'required_plugins': [],
                           'requires_confirmation': True,
                           ...
                           'ue_versions': ['5.6', '5.7', '5.8']},
 'get_sequence_info': {'asset_path_params': ['asset_path'],
                       'description': 'Returns frame rate, playback range (seconds), and the '
                                      'bindings of a Level Sequence.',
                       'effect': 'read',
                       'idempotent': True,
                       'required_plugins': [],
                       ...
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'open_in_sequencer': {'asset_path_params': ['asset_path'],
                       'description': 'Opens a Level Sequence in the Sequencer editor (and focuses '
                                      'it).',
                       'effect': 'write',
                       'idempotent': False,
                       'required_plugins': [],
                       ...
                       'supports_preview': False,
                       'supports_undo': False,
                       'title': 'Open In Sequencer',
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_binding': {'asset_path_params': ['asset_path'],
                    'description': 'Removes a binding (spawnable or possessable) from a Level '
                                   'Sequence by name.',
                    'effect': 'destructive',
                    'idempotent': False,
                    'required_plugins': [],
                    ...
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'set_playback_range': {'asset_path_params': ['asset_path'],
                        'description': 'Sets the playback range (in seconds) of a Level Sequence.',
                        'effect': 'write',
                        'idempotent': False,
                        'required_plugins': [],
                        'requires_confirmation': True,
