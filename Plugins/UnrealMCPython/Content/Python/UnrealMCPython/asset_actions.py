...
ACTION_METADATA = {'asset_exists': {'asset_path_params': ['asset_path'],
                  'description': 'Returns whether an asset exists at the given path.',
                  'effect': 'read',
                  'idempotent': True,
                  'required_plugins': [],
 ...
 'delete_asset': {'asset_path_params': ['asset_path'],
                  'description': 'Deletes an asset from the content browser.',
                  'effect': 'destructive',
                  'idempotent': False,
                  'required_plugins': [],
                  ...
                  'title': 'Delete Asset',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'delete_directory': {'asset_path_params': ['directory_path'],
                      'description': 'Deletes a content-browser directory and its assets.',
                      'effect': 'destructive',
                      'idempotent': False,
                      'required_plugins': [],
                      'requires_confirmation': True,
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'duplicate_asset': {'asset_path_params': ['source_path', 'dest_path'],
                     'description': 'Duplicates an asset to a new content-browser path.',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     'requires_confirmation': True,
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'export_fbx': {'asset_path_params': ['asset_path'],
                'description': 'Exports a StaticMesh, SkeletalMesh, or AnimSequence asset to an '
                               'FBX file.',
                'effect': 'write',
                'idempotent': False,
                'required_plugins': [],
                ...
                'title': 'Export Fbx',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'find_by_query': {'description': "Returns a JSON list of asset paths under '/Game' matching the "
                                  'given query dict.',
                   'effect': 'read',
                   'idempotent': True,
                   'required_plugins': [],
                   ...
                   'title': 'Find By Query',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'find_referencers': {'asset_path_params': ['asset_path'],
                      'description': 'Lists packages that reference the given asset.',
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': [],
                      'requires_confirmation': False,
                      ...
                      'supports_preview': False,
                      'supports_undo': False,
                      'title': 'Find Referencers',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'get_asset_info': {'asset_path_params': ['asset_path'],
                    'description': 'Returns class and package info for an asset.',
                    'effect': 'read',
                    'idempotent': True,
                    'required_plugins': [],
                    'requires_confirmation': False,
                    ...
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'get_dependencies': {'asset_path_params': ['asset_path'],
                      'description': 'Lists packages that the given asset depends on (references).',
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': [],
                      'requires_confirmation': False,
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'get_gltf_import_status': {'asset_path_params': ['destination_path'],
                            'description': 'Polls a scheduled glTF import; returns done + imported '
                                           'assets once Interchange finishes.',
                            'effect': 'read',
                            'idempotent': True,
                            'required_plugins': [],
                            'requires_confirmation': False,
                            ...
                            'supports_preview': False,
                            'supports_undo': False,
                            'title': 'Get Gltf Import Status',
                            'ue_versions': ['5.6', '5.7', '5.8']},
 'get_metadata_tag': {'asset_path_params': ['asset_path'],
                      'description': 'Reads a metadata tag value on an asset (empty string if '
                                     'unset).',
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': [],
                      ...
                      'supports_preview': False,
                      'supports_undo': False,
                      'title': 'Get Metadata Tag',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'get_static_mesh_details': {'asset_path_params': ['asset_path'],
                             'description': 'Retrieves the bounding box and dimensions of a static '
                                            'mesh asset.',
                             'effect': 'read',
                             'idempotent': True,
                             'required_plugins': [],
                             ...
                             'supports_preview': False,
                             'supports_undo': False,
                             'title': 'Get Static Mesh Details',
                             'ue_versions': ['5.6', '5.7', '5.8']},
 'import_fbx': {'asset_path_params': ['destination_path'],
                'description': 'Imports an FBX file as a Static/Skeletal mesh using the legacy FBX '
                               'importer.',
                'effect': 'write',
                'idempotent': False,
                'required_plugins': [],
                ...
                'title': 'Import Fbx',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'import_gltf': {'asset_path_params': ['destination_path'],
                 'description': 'Imports a .glb/.gltf via Interchange, deferred to the editor '
                                'tick. Poll get_gltf_import_status for the result.',
                 'effect': 'write',
                 'idempotent': False,
                 'required_plugins': [],
                 'requires_confirmation': True,
                 ...
                 'title': 'Import Gltf',
                 'ue_versions': ['5.6', '5.7', '5.8']},
 'import_texture': {'asset_path_params': ['destination_path'],
                    'description': 'Imports an image file (PNG/JPG/TGA...) as a Texture2D using '
                                   'the legacy texture importer.',
                    'effect': 'write',
                    'idempotent': False,
                    'required_plugins': [],
                    'requires_confirmation': True,
                    ...
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'list_assets': {'asset_path_params': ['directory_path'],
                 'description': 'Lists asset paths under a content directory.',
                 'effect': 'read',
                 'idempotent': True,
                 'required_plugins': [],
                 'requires_confirmation': False,
                 ...
                 'title': 'List Assets',
                 'ue_versions': ['5.6', '5.7', '5.8']},
 'make_directory': {'asset_path_params': ['directory_path'],
                    'description': 'Creates a content-browser directory.',
                    'effect': 'write',
                    'idempotent': False,
                    'required_plugins': [],
                    'requires_confirmation': True,
                    ...
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_metadata_tag': {'asset_path_params': ['asset_path'],
                         'description': 'Removes a metadata tag from an asset.',
                         'effect': 'destructive',
                         'idempotent': False,
                         'required_plugins': [],
                         'requires_confirmation': True,
                         ...
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'rename_asset': {'asset_path_params': ['source_path', 'dest_path'],
                  'description': 'Renames/moves an asset to a new content-browser path.',
                  'effect': 'destructive',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Rename Asset',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'save_asset': {'asset_path_params': ['asset_path'],
                'description': 'Saves an asset to disk.',
                'effect': 'write',
                'idempotent': False,
                'required_plugins': [],
                'requires_confirmation': True,
                ...
                'title': 'Save Asset',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'set_metadata_tag': {'asset_path_params': ['asset_path'],
                      'description': 'Sets a metadata tag value on an asset.',
                      'effect': 'write',
                      'idempotent': False,
                      'required_plugins': [],
                      'requires_confirmation': True,
