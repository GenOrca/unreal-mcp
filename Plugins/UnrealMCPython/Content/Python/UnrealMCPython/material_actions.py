...
ACTION_METADATA = {'connect_expressions': {'asset_path_params': ['material_path'],
                         'description': 'Creates a connection between two material expressions.',
                         'effect': 'write',
                         'idempotent': False,
                         'required_plugins': [],
                         ...
                         'supports_undo': True,
                         'title': 'Connect Expressions',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'connect_property': {'asset_path_params': ['material_path'],
                      'description': 'Connects an expression output to a material property (e.g. '
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'create_expression': {'asset_path_params': ['material_path'],
                       'description': 'Creates a new material expression node within the supplied '
                                      'material.',
                       'effect': 'write',
                       'idempotent': False,
                       'required_plugins': [],
                       ...
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'create_material': {'asset_path_params': ['material_path'],
                     'description': 'Creates a new Material asset at the given content-browser '
                                    'path.',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'create_material_instance': {'asset_path_params': ['instance_path', 'parent_path'],
                              'description': 'Creates a Material Instance Constant, optionally '
                                             'parented to parent_path.',
                              'effect': 'write',
                              'idempotent': False,
                              'required_plugins': [],
                              'requires_confirmation': True,
                              ...
                              'ue_versions': ['5.6', '5.7', '5.8']},
 'delete_expression': {'asset_path_params': ['material_path'],
                       'description': 'Deletes a material expression node identified by '
                                      'name/desc/type.',
                       'effect': 'destructive',
                       'idempotent': False,
                       'required_plugins': [],
                       ...
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'get_material_info': {'asset_path_params': ['material_path'],
                       'description': 'Returns expression count and a list of expressions (name, '
                                      'class, position) for a material.',
                       'effect': 'read',
                       'idempotent': True,
                       'required_plugins': [],
                       ...
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'get_mi_scalar_param': {'asset_path_params': ['instance_path'],
                         'description': 'Gets the current scalar (float) parameter value from a '
                         ...
                         'supports_preview': False,
                         'supports_undo': False,
                         'title': 'Get Mi Scalar Param',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'get_mi_static_switch': {'asset_path_params': ['instance_path'],
                          'description': 'Gets a static switch parameter from a Material Instance. '
                                         'Returns JSON string.',
                          'effect': 'read',
                          'idempotent': True,
                          'required_plugins': [],
                          ...
                          'supports_preview': False,
                          'supports_undo': False,
                          'title': 'Get Mi Static Switch',
                          'ue_versions': ['5.6', '5.7', '5.8']},
 'get_mi_texture_param': {'asset_path_params': ['instance_path'],
                          'description': 'Gets a texture parameter from a Material Instance. '
                                         'Returns JSON string with texture path.',
                          'effect': 'read',
                          'idempotent': True,
                          'required_plugins': [],
                          'requires_confirmation': False,
                          ...
                          'supports_preview': False,
                          'supports_undo': False,
                          'title': 'Get Mi Texture Param',
                          'ue_versions': ['5.6', '5.7', '5.8']},
 'get_mi_vector_param': {'asset_path_params': ['instance_path'],
                         'description': 'Gets a vector parameter from a Material Instance. Returns '
                                        'JSON string.',
                         'effect': 'read',
                         'idempotent': True,
                         'required_plugins': [],
                         ...
                         'supports_preview': False,
                         'supports_undo': False,
                         'title': 'Get Mi Vector Param',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'layout_expressions': {'asset_path_params': ['material_path'],
                        'description': 'Auto-lays out all expression nodes in a material graph.',
                        'effect': 'write',
                        'idempotent': False,
                        'required_plugins': [],
                        'requires_confirmation': True,
                        ...
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'list_parameters': {'asset_path_params': ['material_path'],
                     'description': 'Lists scalar / vector / texture / static-switch parameter '
                                    'names for a material or material instance.',
                     'effect': 'read',
                     'idempotent': True,
                     'required_plugins': [],
                     'requires_confirmation': False,
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'recompile': {'asset_path_params': ['material_path'],
               'description': "Triggers a recompile of a material or material instance's parent. "
                              'Saves the asset.',
               'effect': 'write',
               'idempotent': False,
               'required_plugins': [],
               ...
               'title': 'Recompile',
               'ue_versions': ['5.6', '5.7', '5.8']},
 'set_expression_property': {'asset_path_params': ['material_path'],
                             'description': 'Sets an editor property on a material expression '
                                            "(e.g. 'r' on a Constant,",
                             'effect': 'write',
                             'idempotent': False,
                             'required_plugins': [],
                             ...
                             'supports_preview': True,
                             'supports_undo': True,
                             'title': 'Set Expression Property',
                             'ue_versions': ['5.6', '5.7', '5.8']},
 'set_instance_parent': {'asset_path_params': ['instance_path', 'parent_path'],
                         'description': 'Reparents a Material Instance Constant to a new parent '
                                        'material/instance.',
                         'effect': 'write',
                         'idempotent': False,
                         'required_plugins': [],
                         ...
                         'supports_preview': True,
                         'supports_undo': True,
                         'title': 'Set Instance Parent',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'set_mi_scalar_param': {'asset_path_params': ['instance_path'],
                         'description': 'Sets the scalar (float) parameter value for a Material '
                                        'Instance Constant.',
                         'effect': 'write',
                         'idempotent': False,
                         'required_plugins': [],
                         ...
                         'supports_preview': True,
                         'supports_undo': True,
                         'title': 'Set Mi Scalar Param',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'set_mi_static_switch': {'asset_path_params': ['instance_path'],
                          'description': 'Sets a static switch parameter on a Material Instance. '
                                         'Returns JSON string.',
                          'effect': 'write',
                          'idempotent': False,
                          'required_plugins': [],
                          ...
                          'supports_preview': True,
                          'supports_undo': True,
                          'title': 'Set Mi Static Switch',
                          'ue_versions': ['5.6', '5.7', '5.8']},
 'set_mi_texture_param': {'asset_path_params': ['instance_path', 'texture_path'],
                          'description': 'Sets a texture parameter on a Material Instance. Provide '
                                         'texture asset path. Returns JSON string.',
                          'effect': 'write',
                          'idempotent': False,
                          'required_plugins': [],
                          'requires_confirmation': True,
                          ...
                          'supports_preview': True,
                          'supports_undo': True,
                          'title': 'Set Mi Texture Param',
                          'ue_versions': ['5.6', '5.7', '5.8']},
 'set_mi_vector_param': {'asset_path_params': ['instance_path'],
                         'description': 'Sets a vector parameter on a Material Instance. Expects '
                                        'value as [R,G,B,A]. Returns JSON string.',
                         'effect': 'write',
                         'idempotent': False,
                         'required_plugins': [],
                         'requires_confirmation': True,
