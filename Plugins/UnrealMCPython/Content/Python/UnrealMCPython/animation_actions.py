...
ACTION_METADATA = {'add_float_curve': {'asset_path_params': ['asset_path'],
                     'description': 'Adds a float curve to an AnimSequence, optionally with an '
                                    'initial key at time_seconds=value.',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     ...
                     'supports_undo': True,
                     'title': 'Add Float Curve',
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'add_notify_track': {'asset_path_params': ['asset_path'],
                      'description': 'Adds a notify track to an AnimSequence.',
                      'effect': 'write',
                      'idempotent': False,
                      'required_plugins': [],
                      'requires_confirmation': True,
                      ...
                      'supports_preview': True,
                      'supports_undo': True,
                      'title': 'Add Notify Track',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'add_socket': {'asset_path_params': ['asset_path'],
                'description': 'Adds a socket on a bone of a SkeletalMesh. location=[x,y,z], '
                ...
                'title': 'Add Socket',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'add_sync_marker': {'asset_path_params': ['asset_path'],
                     'description': 'Adds a sync marker at a time (seconds) on a notify track. '
                                    'Creates the track if needed.',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     'requires_confirmation': True,
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'find_socket': {'asset_path_params': ['asset_path'],
                 'description': 'Returns details of a named socket on a SkeletalMesh, or '
                 ...
                 'title': 'Find Socket',
                 'ue_versions': ['5.6', '5.7', '5.8']},
 'get_anim_sequence_info': {'asset_path_params': ['asset_path'],
                            'description': 'Returns length, frame count, approximate fps, and '
                                           'skeleton path of an AnimSequence.',
                            'effect': 'read',
                            'idempotent': True,
                            'required_plugins': [],
                            'requires_confirmation': False,
                            ...
                            'supports_preview': False,
                            'supports_undo': False,
                            'title': 'Get Anim Sequence Info',
                            'ue_versions': ['5.6', '5.7', '5.8']},
 'get_skeletal_mesh_info': {'asset_path_params': ['asset_path'],
                            'description': 'Returns the skeleton path, socket count, and '
                                           'material-slot count of a SkeletalMesh.',
                            'effect': 'read',
                            'idempotent': True,
                            'required_plugins': [],
                            'requires_confirmation': False,
                            ...
                            'supports_preview': False,
                            'supports_undo': False,
                            'title': 'Get Skeletal Mesh Info',
                            'ue_versions': ['5.6', '5.7', '5.8']},
 'get_skeleton_info': {'asset_path_params': ['asset_path'],
                       'description': 'Returns curve metadata names for a Skeleton asset.',
                       'effect': 'read',
                       'idempotent': True,
                       'required_plugins': [],
                       'requires_confirmation': False,
                       ...
                       'supports_preview': False,
                       'supports_undo': False,
                       'title': 'Get Skeleton Info',
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'list_bones': {'asset_path_params': ['asset_path'],
                'description': 'Lists reference-skeleton bones (name, index, parent) of a '
                               'SkeletalMesh.',
                'effect': 'read',
                'idempotent': True,
                'required_plugins': [],
                ...
                'title': 'List Bones',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'list_curves': {'asset_path_params': ['asset_path'],
                 'description': 'Lists float animation curve names on an AnimSequence.',
                 'effect': 'read',
                 'idempotent': True,
                 'required_plugins': [],
                 'requires_confirmation': False,
                 ...
                 'title': 'List Curves',
                 'ue_versions': ['5.6', '5.7', '5.8']},
 'list_notifies': {'asset_path_params': ['asset_path'],
                   'description': 'Lists notify event names on an AnimSequence.',
                   'effect': 'read',
                   'idempotent': True,
                   'required_plugins': [],
                   'requires_confirmation': False,
                   ...
                   'title': 'List Notifies',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'list_notify_tracks': {'asset_path_params': ['asset_path'],
                        'description': 'Lists the notify track names on an AnimSequence.',
                        'effect': 'read',
                        'idempotent': True,
                        'required_plugins': [],
                        'requires_confirmation': False,
                        ...
                        'supports_preview': False,
                        'supports_undo': False,
                        'title': 'List Notify Tracks',
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'list_sockets': {'asset_path_params': ['asset_path'],
                  'description': 'Lists sockets on a SkeletalMesh (name, bone, relative '
                                 'location/rotation).',
                  'effect': 'read',
                  'idempotent': True,
                  'required_plugins': [],
                  ...
                  'title': 'List Sockets',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'list_sync_markers': {'asset_path_params': ['asset_path'],
                       'description': 'Lists sync markers (name + time) on an AnimSequence.',
                       'effect': 'read',
                       'idempotent': True,
                       'required_plugins': [],
                       'requires_confirmation': False,
                       ...
                       'supports_preview': False,
                       'supports_undo': False,
                       'title': 'List Sync Markers',
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_curve': {'asset_path_params': ['asset_path'],
                  'description': 'Removes a float curve from an AnimSequence.',
                  'effect': 'destructive',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Remove Curve',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_notify_track': {'asset_path_params': ['asset_path'],
                         'description': 'Removes a notify track (and its notifies) from an '
                                        'AnimSequence.',
                         'effect': 'destructive',
                         'idempotent': False,
                         'required_plugins': [],
                         ...
                         'supports_preview': True,
                         'supports_undo': False,
                         'title': 'Remove Notify Track',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_socket': {'asset_path_params': ['asset_path'],
                   'description': 'Removes a named socket from a SkeletalMesh.',
                   'effect': 'destructive',
                   'idempotent': False,
                   'required_plugins': [],
                   'requires_confirmation': True,
