...
ACTION_METADATA = {'add_actor_tag': {'description': 'Adds a tag to an actor (Actor.Tags).',
                   'effect': 'write',
                   'idempotent': False,
                   'required_plugins': [],
 ...
 'attach_actor': {'description': 'Attaches one actor to another (keeps world transform). Optional '
                                 'socket on the parent.',
                  'effect': 'write',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Attach Actor',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'delete_by_label': {'description': 'Deletes an actor with the specified name from the current '
                                    'level.',
                     'effect': 'destructive',
                     'idempotent': False,
                     'required_plugins': [],
                     ...
                     'supports_preview': True,
                     'supports_undo': False,
                     'title': 'Delete By Label',
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'detach_actor': {'description': 'Detaches an actor from its parent (keeps world transform).',
                  'effect': 'write',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Detach Actor',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'duplicate_actor': {'description': 'Duplicates a specific actor (by label) with an optional '
                                    '[x,y,z] offset.',
                     'effect': 'write',
                     'idempotent': False,
                     'required_plugins': [],
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'duplicate_selected': {'description': 'Duplicates all selected actors in the editor and applies a '
                                       'position offset to each duplicate.',
                        'effect': 'write',
                        'idempotent': False,
                        'required_plugins': [],
                        'requires_confirmation': True,
                        ...
                        'ue_versions': ['5.6', '5.7', '5.8']},
 'get_actor_bounds': {'description': "Returns an actor's world-space bounds (origin + box extent).",
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': [],
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'get_actor_folder': {'description': 'Returns the World Outliner folder path of an actor.',
                      'effect': 'read',
                      'idempotent': True,
                      'required_plugins': [],
                      'requires_confirmation': False,
                      ...
                      'supports_preview': False,
                      'supports_undo': False,
                      'title': 'Get Actor Folder',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'get_actor_tags': {'description': 'Returns the gameplay tags (Actor.Tags) of an actor.',
                    'effect': 'read',
                    'idempotent': True,
                    'required_plugins': [],
                    'requires_confirmation': False,
                    ...
                    'supports_preview': False,
                    'supports_undo': False,
                    'title': 'Get Actor Tags',
                    'ue_versions': ['5.6', '5.7', '5.8']},
 'get_actors_of_class': {'asset_path_params': ['class_path'],
                         'description': 'Lists labels of level actors of the given class path '
                                        "(e.g. '/Script/Engine.PointLight').",
                         'effect': 'read',
                         'idempotent': True,
                         'required_plugins': [],
                         'requires_confirmation': False,
                         ...
                         'supports_preview': False,
                         'supports_undo': False,
                         'title': 'Get Actors Of Class',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'get_all_details': {'description': 'Lists all actors in the current level with detailed '
                     ...
                     'ue_versions': ['5.6', '5.7', '5.8']},
 'get_attached_actors': {'description': 'Lists the labels of actors attached to the given actor.',
                         'effect': 'read',
                         'idempotent': True,
                         'required_plugins': [],
                         'requires_confirmation': False,
                         ...
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'get_component_property': {'description': 'Reads a property on a named component of a live level '
                                           'actor.',
                            'effect': 'read',
                            'idempotent': True,
                            'required_plugins': [],
                            ...
                            'ue_versions': ['5.6', '5.7', '5.8']},
 'get_in_view_frustum': {'description': 'Retrieves a list of actors that are potentially visible '
                         ...
                         'supports_preview': False,
                         'supports_undo': False,
                         'title': 'Get In View Frustum',
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'get_property': {'description': 'Gets a property value from an actor using get_editor_property().',
                  'effect': 'read',
                  'idempotent': True,
                  'required_plugins': [],
                  'requires_confirmation': False,
                  ...
                  'title': 'Get Property',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'get_selected_actors': {'description': 'Lists the currently selected level actors (label + '
                                        'class).',
                         'effect': 'read',
                         'idempotent': True,
                         'required_plugins': [],
                         ...
                         'ue_versions': ['5.6', '5.7', '5.8']},
 'get_transform': {'description': "Returns an actor's world location, rotation, and scale.",
                   'effect': 'read',
                   'idempotent': True,
                   'required_plugins': [],
                   'requires_confirmation': False,
                   ...
                   'title': 'Get Transform',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'invert_selection': {'description': 'Inverts the selection of actors in the current level.',
                      'effect': 'write',
                      'idempotent': False,
                      'required_plugins': [],
                      'requires_confirmation': True,
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'line_trace': {'description': 'Performs a line trace (raycast) and returns hit information '
                ...
                'title': 'Line Trace',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'list_actor_components': {'description': 'Lists the components on an actor (name + class).',
                           'effect': 'read',
                           'idempotent': True,
                           'required_plugins': [],
                           'requires_confirmation': False,
                           ...
                           'supports_preview': False,
                           'supports_undo': False,
                           'title': 'List Actor Components',
                           'ue_versions': ['5.6', '5.7', '5.8']},
 'list_all_with_locations': {'description': 'Lists all actors in the current level along with '
                                            'their world locations.',
                             'effect': 'read',
                             'idempotent': True,
                             'required_plugins': [],
                             'requires_confirmation': False,
                             ...
                             'supports_preview': False,
                             'supports_undo': False,
                             'title': 'List All With Locations',
                             'ue_versions': ['5.6', '5.7', '5.8']},
 'remove_actor_tag': {'description': 'Removes a tag from an actor (Actor.Tags).',
                      'effect': 'destructive',
                      'idempotent': False,
                      'required_plugins': [],
                      'requires_confirmation': True,
                      ...
                      'supports_preview': True,
                      'supports_undo': False,
                      'title': 'Remove Actor Tag',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'rename_actor': {'description': 'Renames an actor (changes its World Outliner label).',
                  'effect': 'destructive',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Rename Actor',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'select_actors': {'description': 'Selects the given actors by label in the editor (replaces '
                                  'current selection).',
                   'effect': 'write',
                   'idempotent': False,
                   'required_plugins': [],
                   ...
                   'title': 'Select Actors',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'select_all': {'description': 'Selects all actors in the current level.',
                'effect': 'write',
                'idempotent': False,
                'required_plugins': [],
                'requires_confirmation': True,
                ...
                'title': 'Select All',
                'ue_versions': ['5.6', '5.7', '5.8']},
 'set_actor_folder': {'description': 'Sets the World Outliner folder path of an actor.',
                      'effect': 'write',
                      'idempotent': False,
                      'required_plugins': [],
                      'requires_confirmation': True,
                      ...
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'set_actor_hidden': {'description': 'Shows/hides an actor in the editor viewport (temporary '
                                     'editor visibility).',
                      'effect': 'write',
                      'idempotent': False,
                      'required_plugins': [],
                      ...
                      'supports_preview': True,
                      'supports_undo': True,
                      'title': 'Set Actor Hidden',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'set_component_property': {'description': 'Sets a property on a named component of a live level '
                                           "actor (e.g. PointLightComponent 'intensity').",
                            'effect': 'write',
                            'idempotent': False,
                            'required_plugins': [],
                            'requires_confirmation': True,
                            ...
                            'ue_versions': ['5.6', '5.7', '5.8']},
 'set_location': {'description': 'Set location.',
                  'effect': 'write',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Set Location',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'set_property': {'description': 'Sets a property value on an actor using set_editor_property().',
                  'effect': 'write',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Set Property',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'set_rotation': {'description': 'Set rotation.',
                  'effect': 'write',
                  'idempotent': False,
                  'required_plugins': [],
                  'requires_confirmation': True,
                  ...
                  'title': 'Set Rotation',
                  'ue_versions': ['5.6', '5.7', '5.8']},
 'set_scale': {'description': 'Set scale.',
               'effect': 'write',
               'idempotent': False,
               'required_plugins': [],
               'requires_confirmation': True,
               ...
               'title': 'Set Scale',
               'ue_versions': ['5.6', '5.7', '5.8']},
 'set_transform': {'description': 'Sets the transform (location, rotation, scale) of a specified '
                                  'actor.',
                   'effect': 'write',
                   'idempotent': False,
                   'required_plugins': [],
                   ...
                   'title': 'Set Transform',
                   'ue_versions': ['5.6', '5.7', '5.8']},
 'spawn_from_class': {'asset_path_params': ['class_path'],
                      'description': 'Spawns an actor from the specified class path at the given '
                      ...
                      'supports_preview': True,
                      'supports_undo': True,
                      'title': 'Spawn From Class',
                      'ue_versions': ['5.6', '5.7', '5.8']},
 'spawn_from_object': {'asset_path_params': ['asset_path'],
                       'description': 'Spawns an actor from the specified asset path at the given '
                                      'location.',
                       'effect': 'write',
                       'idempotent': False,
                       'required_plugins': [],
                       ...
                       'supports_preview': True,
                       'supports_undo': True,
                       'title': 'Spawn From Object',
                       'ue_versions': ['5.6', '5.7', '5.8']},
 'spawn_on_surface_raycast': {'asset_path_params': ['asset_or_class_path'],
                              'description': 'Spawn on surface raycast.',
                              'effect': 'write',
                              'idempotent': False,
                              'required_plugins': [],
                              'requires_confirmation': True,
                              ...
                              'supports_preview': True,
                              'supports_undo': True,
                              'title': 'Spawn On Surface Raycast',
                              'ue_versions': ['5.6', '5.7', '5.8']}}
